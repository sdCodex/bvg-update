        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <div class="swiper-slide-content">
                    ...
                    <p class="text-lg mb-12 text-gray-300 max-w-2xl mx-auto text-shadow">
                        Nurturing future leaders through holistic education, spiritual values, and academic excellence
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="<?php echo $base_url; ?>/programs/index.php" class="btn-primary">
            ...
            <div class="swiper-slide">
                ...
                <div class="swiper-slide-content">
                    ...
                    <p class="text-xl md:text-2xl mb-8 text-gray-200 text-shadow">
                        Mind, Body, and Spirit in Perfect Harmony
                    </p>
                    <p class="text-lg mb-12 text-gray-300 max-w-2xl mx-auto text-shadow">
            ...
            <div class="swiper-slide">
                ...
                <div class="swiper-slide-content">
                    ...
                    <p class="text-lg mb-12 text-gray-300 max-w-2xl mx-auto text-shadow">
                        Preserving and propagating the timeless wisdom of the Vedas in contemporary education
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="<?php echo $base_url; ?>/programs/index.php#vedic" class="btn-primary">
                            Vedic Studies <i class="fas fa-om ml-2"></i>
                        </a>
                        <a href="<?php echo $base_url; ?>/about.php#mission" class="btn-secondary">
                            Our Philosophy
                        </a>
                    </div>
                </div>
...
<section class="bg-white py-12 border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                <div class="text-3xl md:text-4xl font-bold text-accent mb-2">5+ Teaching</div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-4">
                        <div class="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
                            <img src="<?php echo $base_url; ?>/images/background/campus-1.jpg" alt="Campus Building" class="w-full h-32 object-cover rounded-lg mb-3">
                        ...
                        <div class="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
                            ...
                            <h4 class="font-semibold text-primary">Digital Library</h4>
                        </div>
                    </div>
                    <div class="space-y-4 mt-8">
                        <div class="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
                            <img src="<?php echo $base_url; ?>/images/background/sports.jpg" alt="Sports" class="w-full h-32 object-cover rounded-lg mb-3">
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-primary mb-4">
                The <span class="text-accent">Bhaktivedanta</span> Advantage
            </h2>
        </div>
...
<section class="section-padding bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-primary mb-4">
                Life at <span class="text-accent">Bhaktivedanta</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="relative overflow-hidden rounded-2xl mb-4">
                    <img src="<?php echo $base_url; ?>/images/daily-routine.jpeg" alt="Daily Routine" class="w-full h-48 object-cover">
                </div>
            ...
            <div class="text-center">
                ...
                <h4 class="font-semibold text-primary mb-2">Hawan Ceremony Day</h4>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center mb-4">
                    <img src="<?php echo $base_url; ?>/images/rahul-sharma.jpg" alt="Rahul Sharma" class="w-12 h-12 bg-accent rounded-full flex items-center justify-center text-white font-bold mr-4">
                    </img>
                    <div>
                        <div class="font-semibold text-primary">Rahul Sharma</div>
                        <div class="text-sm text-secondary">Parent of Aarav (Grade 5)</div>
                    </div>
                </div>
                ...
                <p class="text-secondary italic">
                    "The transformation in my child's discipline and values is remarkable. The perfect blend of modern education and spiritual teachings is exactly what we wanted."
                </p>
            </div>

            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center mb-4">
                    <img src="<?php echo $base_url; ?>/images/priya-singh.jpg" alt="Priya Singh" class="w-12 h-12 bg-accent rounded-full flex items-center justify-center text-white font-bold mr-4">
                    </img>
                    <div>
                        <div class="font-semibold text-primary">Priya Singh</div>
                        <div class="text-sm text-secondary">Parent of Riya (Grade 8)</div>
                    </div>
                </div>
                <div class="flex text-yellow-400 mb-3">
                    <i class="fas fa-star"></i>
                ...
                <p class="text-secondary italic">
                    "The teachers are incredibly dedicated. My daughter has not only improved academically but also developed strong moral character and confidence."
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center mb-4">
                    <div>
                        <img class="w-12 h-12 bg-accent rounded-full flex items-center justify-center text-white font-bold mr-4" src="<?php echo $base_url; ?>/images/amit-verma.jpg" alt="Dr. Amit Verma">
                    </div>
                    <div>
                        <div class="font-semibold text-primary">Dr. Amit Verma</div>
                        <div class="text-sm text-secondary">Parent of Ved (Grade 10)</div>
                    </div>
                </div>
                <div class="flex text-yellow-400 mb-3">
                    <i class="fas fa-star"></i>
                ...
                <p class="text-secondary italic">
                    "As a doctor, I appreciate the emphasis on yoga and mental wellbeing. The holistic approach to education here is truly commendable."
                </p>
            </div>
        </div>
    </div>
